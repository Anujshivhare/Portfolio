    ...
    >
      ...
      >
        <div className="flex flex-col justify-center">
          ...
          >
            I'm a B.Tech 4th year Student of ShriRam college of engineering and
            management, Banmor. With expertise in Development in ReactJS,
            NodeJS, MongoDB, SQL & much more. As a dynamic and forward-thinking
            programmer, I'm committed to staying up to date with the latest
          ...
          <div className="flex flex-row gap-2">
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://www.linkedin.com/in/anuj-shivhare-4439062ba/"
              smooth
              duration={550}
              data-aos="fade-up"
              data-aos-delay="2000"
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://github.com/Anujshivhare"
              smooth
              duration={600}
              data-aos="fade-up"
              data-aos-delay="3000"
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://www.instagram.com/_anuj_shivhare_
/              "
              smooth
              duration={650}
              data-aos="fade-up"
